...
const samplePosts = [
  {
    ...
    author: 'Alice',
    contents: 'Redux is a state management tool',
    tags: ['redux', 'javascript'],
  },
  {
    title: 'Node.js Basics',
    author: 'Bob',
    contents: 'Node.js allows JavaScript to run on the server side',
    tags: ['nodejs', 'javascript'],
  },
  {
    title: 'Understanding Express',
    author: 'Alice',
    contents: 'Express is a web application framework for Node.js',
    tags: ['express', 'nodejs'],
  },
  {
...
describe('listing posts', () => {
  ...
  test('should be able to filter post by Author', async () => {
    const posts = await listPostsByAuthor('Charlie')
